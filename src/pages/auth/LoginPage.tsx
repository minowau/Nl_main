        ...
        >
          <motion.div variants={itemVariants}>
            <div className="flex items-center gap-3 mb-3">
                <h2 className="text-4xl font-black text-slate-900 tracking-tight">Mission Access</h2>
            ...
            <p className="text-slate-500 mb-10 text-lg font-medium italic">"The matrix is ready for your next deployment."</p>
          </motion.div>
